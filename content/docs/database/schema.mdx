...
<Card title="Code-first approach">
  We're using a code-first approach, defining the schema in code and generating
  SQL from it. This allows for full type-safety and a straightforward flow for
